...
inputs = {"X": tf.placeholder(tf.float32, [None, 4])}
outputs = {"Y": tf.placeholder(tf.float32, [None, 3])}
...
with tf.Session() as sess:
    ...
    tf.saved_model.simple_save(sess, "/tmp/iris.export", inputs=inputs, outputs=outputs)
